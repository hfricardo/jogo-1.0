demo = {
   ...
   [{"featureType":"water","stylers":[{"saturation":43},{"lightness":-11},{"hue":"#0088ff"}]},{"featureType":"road","elementType":"geometry.fill","stylers":[{"hue":"#ff0000"},{"saturation":-100},{"lightness":99}]},{"featureType":"road","elementType":"geometry.stroke","stylers":[{"color":"#808080"},{"lightness":54}]},{"featureType":"landscape.man_made","elementType":"geometry.fill","stylers":[{"color":"#ece2d9"}]},{"featureType":"poi.park","elementType":"geometry.fill","stylers":[{"color":"#ccdca1"}]},{"featureType":"road","elementType":"labels.text.fill","stylers":[{"color":"#767676"}]},{"featureType":"road","elementType":"labels.text.stroke","stylers":[{"color":"#ffffff"}]},{"featureType":"poi","stylers":[{"visibility":"off"}]},{"featureType":"landscape.natural","elementType":"geometry.fill","stylers":[{"visibility":"on"},{"color":"#b8cb93"}]},{"featureType":"poi.park","stylers":[{"visibility":"on"}]},{"featureType":"poi.sports_complex","stylers":[{"visibility":"on"}]},{"featureType":"poi.medical","stylers":[{"visibility":"on"}]},{"featureType":"poi.business","stylers":[{"visibility":"simplified"}]}],
    ...
    showSwal: function(type,indice) {

        if (type == 'chama-paciente') {
            swal({
                title: 'Chamando Paciente!',
                text: objOrdem[indice].valor_ini,
                type: 'warning',
        ...
        } else if (type == 'novo_jogador') {
            swal({
                title: 'Novo jogador.',
                html: '<div class="form-group">' +
                    '<h3>Entre com seu nome.</h3>' +
                    '<input id="nomeJogador" type="text" class="form-control" style="margin:auto; width:80%; text-align:center; font-size: larger;" value="-1" />' +
                    '</div>',
                showCancelButton: true,
                confirmButtonClass: 'btn btn-success',
                cancelButtonClass: 'btn btn-danger',
        ...
        else if (type == 'entra-prioridade') {
            swal({
                title: 'ATENDIMENTO PRIORITÁRIO.',
                html: '<div class="form-group">' +
                '<h3>Entre com o nome e sobrenome.</h3>' +
                    '<input id="busca" type="text" class="form-control" style="margin:auto; width:80%; text-align:center; font-size: larger;" />' +
                    '</div>',
                showCancelButton: true,
                confirmButtonClass: 'btn btn-success',
                cancelButtonClass: 'btn btn-danger',
                ...
                if (result.value==true)
                {
                    entra_prioridade($("#busca").val());
                }
            }).catch(swal.noop)
        }
        else if (type == 'entra-normal') {
            swal({
                ...
                if (result.value==true)
                {
                    entra_normal($("#busca").val());
                }
            }).catch(swal.noop)
        }
        else if (type == 'busca-linear') {
            swal({
                title: 'Entre com um valor a ser buscado.',
                html: '<div class="form-group">' +
                    '<input id="busca" type="text" class="form-control" style="margin:auto; width:80%; text-align:center; font-size: larger;" />' +
                    '</div>',
                showCancelButton: true,
        ...
        }else if (type == 'remove-ordenado') {
            swal({
                title: 'Entre com um valor a ser removido.',
                html: '<div class="form-group">' +
                    '<input id="busca" type="text" class="form-control" style="margin:auto; width:80%; text-align:center; font-size: larger;" />' +
                    '</div>',
                showCancelButton: true,
    ...
    else if (type == 'remove-desordenado') {
            swal({
                title: 'Entre com um valor a ser removido.',
                html: '<div class="form-group">' +
                    '<input id="busca" type="text" class="form-control" style="margin:auto; width:80%; text-align:center; font-size: larger;" />' +
